  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="mb-6 border-b border-slate-200 pb-4">
        <h1 className="text-3xl font-bold text-slate-950">Packet Preparation</h1>
        <p className="mt-2 text-slate-600">
          Review the simulated artifacts generated by the rescue agent.
        </p>
      </div>

      <div className="grid gap-6 lg:grid-cols-2">
        <Section eyebrow="Orchestration" title="Agent timeline">
        ...
        <Section eyebrow="Readiness" title="Packet readiness check">
          {!result ? (
            <div className="flex flex-col items-center justify-center rounded-lg border border-dashed border-slate-200 bg-slate-50 p-8 text-slate-500">
              ...
              <p>Awaiting rescue agent results...</p>
            </div>
          ) : (
            <div className="space-y-4">
              <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">
                <div className="mb-2 flex flex-wrap items-center gap-3">
                  <span className="font-semibold text-slate-900">
                    {result.readinessCheck.status.replaceAll("_", " ")}
                  </span>
              ...
              <div className="rounded-lg border border-amber-200 bg-amber-50 p-4">
                <div className="text-sm font-bold text-amber-950">Missing requirements</div>
      ...
      {result ? (
        <Section eyebrow="Artifacts" title="Generated rescue packet">
